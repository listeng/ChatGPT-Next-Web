...
const en: LocaleType = {
  ...
  Error: {
    Unauthorized: isApp
      ? "Invalid API Key detected, please go to the [Settings](/#/settings) page to check if the API Key is configured correctly."
      : "User not logged in, please go to [Login](/#/auth) to log in.",
  },
  Auth: {
    Return: "Return",
