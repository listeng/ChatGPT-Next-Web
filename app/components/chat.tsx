  ...
  return (
    <div
      className={clsx(
        ...
        "clickable " +
          (props.alwayShow
            ? styles["chat-input-action-static-width"]
            : styles["chat-input-action-dynamic-width"]),
      )}
      onClick={() => {
        props.onClick();
    ...
    >
      ...
      <div
        className={
          styles["text"] + " " + (props.alwayShow ? styles["text-static"] : "")
        }
        ref={textRef}
      >
        {props.text}
...
export function Chat() {
  const chatStore = useChatStore();
  const session = chatStore.currentSession();
  return <AChat key={session.id}></AChat>;
}
